...
const HeroSection = ({ onSearch }) => {
  ...
  const handleSearch = async () => {
    try {
      const url = `https://beta-house-backend-b96p.onrender.com/api/properties?location=${location}&type=${propertyType}&bedrooms=${bedrooms}`;
          ...
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 md:gap-8 py-4 px-4 md:px-6">
            ...
            <div className="flex flex-col justify-center">
              ...
              <input
                ...
                className="mt-1 border-b border-gray-400 outline-none text-gray-700"
                value={location}
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  className="border border-gray-500 w-6 h-6 rounded-full text-2xl text-black flex items-center justify-center"
